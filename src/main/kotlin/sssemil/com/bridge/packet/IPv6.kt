...
data class IPv6(
    ...
    var hopLimit: Byte = 0,
    var sourceAddress: Inet6Address = IPV6_NONE,
    var destinationAddress: Inet6Address = IPV6_NONE,
    ...
    init {
        ...
        sourceAddress = IPV6_NONE
        destinationAddress = IPV6_NONE
    }
    ...
    override fun serialize(): ByteArray {
        ...
        val data = ByteArray(HEADER_LENGTH + this.payloadLength)
    ...
    override fun deserialize(data: ByteArray, offset: Int, length: Int): IPacket {
        ...
        val payload: IPacket = IPv6.nextHeaderClassMap[nextHeader]?.invoke() ?: Data()
